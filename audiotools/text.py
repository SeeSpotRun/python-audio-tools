...
OPT_MERGE = u"merge gapless tracks into single output file"
OPT_GAP_SECS = u"seconds of silence/padding at the end of track to indicate a gap"
OPT_GAP_SENS = u"sensitivity for gapless track detection; higher values will detect more tracks as gapless"
OPT_CAT_NOSORT = u"don't sort the input files into album order"
...
OPT_CAT_MERGE = u"merging gapless tracks arguments"
